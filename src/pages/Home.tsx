...
var value = "menu1"
      ...
      case 'menu1':
        return (
          <Card
            ...
            img4={'src/assets/dot.gif'}
            img5={'src/assets/barbirth.jpg'}
          />
        );
  ...
  <AccordionItem className=' p-1 my-2 rounded bg-neutral-700'>
    ...
    <AccordionPanel pb={4} className='bg-white '>
 ...
 <a href="#" onClick={()=>handleMenuClick("menu5") }> 	자평명리학 오늘의 운세</a>
  ...
  <AccordionItem className='bg-neutral-700 p-1 my-2 rounded'>
    <h2 className='text-white'>
      <AccordionButton>
        <Box as="span" flex='1' textAlign='left'>
        인생풀이
 ...
 <a href="#"> 	인생풀이</a>
      ...
      <div className=" m-2 ml-36 flex-1 flex flex-col items-center gap-5">

        <div className='bg-app h-12 w-2/3 p-3 rounded'>  <h1 className=' text-white text-sm font-bold'>▶ 올해의토정비결</h1> </div>
      {/* <Card img1={"src/assets/contentPIC/saju01.gif"} img2={"src/assets/contentTEXT/saju01.jpg"} img3={"src/assets/contentPIC/saju01.jpg"} img4={"src/assets/dot.gif"} img5={"src/assets/barbirth.jpg"}/>
   */}
   {renderCard()}
